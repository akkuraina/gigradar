  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transparent premium-space">
      <div className="glass rounded-2xl p-10 w-full max-w-md flex flex-col gap-8 items-center text-center shadow-none">
        ...
        <h2 className="text-2xl font-extrabold mb-2 text-gray-800 dark:text-gray-100">Create your account</h2>
        <p className="text-sm text-gray-500 dark:text-gray-300 mb-2">
          Or{' '}
          <Link href="/login" className="font-medium underline hover:opacity-80">sign in to your existing account</Link>
        </p>
        <button
